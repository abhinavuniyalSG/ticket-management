...
/** Matches the breakpoint the tickets/users/departments tables switch to their mobile card layout at. */
...
type FormErrors = Partial<
  Record<"title" | "description" | "departmentId", string>
>;
...
export function TicketForm({
  ...
  const isTableView = useMediaQuery(TABLE_VIEW_QUERY);
      ...
      {showAssignee && (
        ...
        >
          <Select
            ...
            onChange={(e) =>
              setValues((prev) => ({ ...prev, assignedToId: e.target.value }))
            }
